...
<body style="background-color:#212529;">
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" aria-current="page" href="index1.php">Home</a>
                    </li>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="images\\C:\xampp\htdocs\Bank\images\about.png.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Prasad Sonawane </h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Deogiri Institute of  Engineering,Aurangabad</b></p>
    </center>
